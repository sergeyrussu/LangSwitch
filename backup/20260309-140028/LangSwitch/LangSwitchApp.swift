...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private var inputSourceObserverInstalled = false
    ...
    deinit {
        if inputSourceObserverInstalled {
    ...
    private func registerKeyboardSourceObserver() {
        ...
        inputSourceObserverInstalled = true
    }
    ...
    private func text(_ key: TextKey) -> String {
        ...
        case .russian:
            switch key {
            case .credits: return "Создал Сергей Руссу, 2026"
        ...
        case .english:
            switch key {
            case .credits: return "Created by Sergey Russu, 2026"
        ...
        case .hindi:
            switch key {
            case .credits: return "निर्माण: Sergey Russu, 2026"
        ...
        case .chinese:
            switch key {
            case .credits: return "作者：Sergey Russu，2026年"
